    ...
    public class InspectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Inspection inspection)
        {
            ...
            if (enterprise == null || inspector == null || violationType == null)
            {
                ...
                ViewData["EnterpriseId"] = new SelectList(_context.Enterprises, "EnterpriseId", "Name", inspection.EnterpriseId);
                ViewData["ViolationTypeId"] = new SelectList(_context.ViolationTypes, "ViolationTypeId", "Name", inspection.ViolationTypeId);
                ViewData["InspectorId"] = new SelectList(_context.Inspectors, "InspectorId", "FullName", inspection.InspectorId);
