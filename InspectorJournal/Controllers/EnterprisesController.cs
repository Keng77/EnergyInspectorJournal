...
namespace InspectorJournal.Controllers
{
    public class EnterprisesController : Controller
    {
        ...
        public IActionResult Index(string EnterpriseName = "", string EnterpriseAddress = "", SortState sortOrder = SortState.No, int page = 1)
        {
            ...
            {
                var sessionData = Infrastructure.SessionExtensions.Get(HttpContext.Session, "Enterprise");
                if (sessionData != null)
                {
        ...
        private static IQueryable<Enterprise> Sort_Search(IQueryable<Enterprise> enterprises, SortState sortOrder, string searchEnterpriseName, string searchEnterpriseAddress)
        {
